...
const store = {
  settings: { intervalMinutes: 720, lookalikeEveryNRuns: 2, notifications: true, listUpdates: true, defaultDisclosure: { text: "human" }, myListUrl: "https://gist.githubusercontent.com/jane/abc/raw" },
  profiles: {
